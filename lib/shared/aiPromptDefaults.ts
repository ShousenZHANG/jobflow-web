export const DEFAULT_CV_RULES = [
  ...
  "When JD responsibilities are clearly under-covered, you may add up to 3 new bullets only if grounded by explicit base resume evidence (latest experience / projects / skills).",
