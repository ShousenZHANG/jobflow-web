export const DEFAULT_CV_RULES = [
  ...
  "Strictly obey the Required additions line in the prompt payload (if it says add N to M, you must add within that range).",
  "Place added bullets first in the same order as the missing responsibilities they cover.",
  "Before final output, self-check: (1) all base bullets are preserved verbatim, (2) additions count matches requirement, (3) top-3 responsibilities are fully covered.",
