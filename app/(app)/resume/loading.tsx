export default function LoadingResume() {
  return (
    <main className="flex h-full min-h-0 flex-1 flex-col">
      <section className="flex h-full min-h-0 flex-1 flex-col rounded-3xl border-2 border-slate-900/10 bg-white/80 shadow-[0_18px_40px_-32px_rgba(15,23,42,0.3)] backdrop-blur overflow-hidden route-loading-enter">
        {/* Header skeleton */}
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          <div className="hidden lg:flex w-56 shrink-0 border-r border-slate-900/10 flex-col p-3 gap-2">
          ...
          <div className="flex flex-1 flex-col min-h-0">
            {/* Mobile nav skeleton */}
            <div className="lg:hidden flex gap-2 px-4 py-2 border-b border-slate-900/10 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-6 lg:px-8">
              ...
              <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-4 space-y-3">
          ...
          <div className="hidden md:flex w-[400px] shrink-0 border-l border-slate-900/10 flex-col p-4">
        ...
        <div className="shrink-0 border-t border-slate-900/10 px-4 py-3 flex items-center justify-between">
